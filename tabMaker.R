...
cat("------------------------------------------------------------------------------------------------------------- \n")
cat(paste("For help, write \n",
	"help.tabMaker() in the console for parameters \n",
	"help.tabMaker.Example() for an example of usage. \n",
	"If your have questions, contact gabriel @ lemyre . org. \n",sep=""))
cat("------------------------------------------------------------------------------------------------------------- \n \n")

help.tabMaker = function(){
	cat(paste("For the code to run in LaTeX, your TeX editor requires the package ",chr(92),"usepackage{caption} if caption=TRUE \n",sep=""))
	cat("------------------------------------------------------------------------------------------------------------- \n")
	cat(paste("Prints the LaTeX code for a tabular environnement from an R matrix object \n",
		"[ Make.LaTeX.Table ] \n",
...
help.tabMaker.Example = function(){
